...
Function Overloading: This occurs when multiple functions with the same name exist in the same scope, but they have different parameter lists. The appropriate function to be called is determined by the number or types of arguments passed during compilation.
